      ...
      <div className='footer-content container'>
        <div className='footer-box'>
          ...
          <div className='social'>
            ...
            <a href='https://github.com/alqazzaaz' aria-label={t('people.abdullah.githubLabel')}><i className='bi-github'></i></a>
            <a href='https://www.linkedin.com/in/abdullah-al-qazzaz-93b316367/' aria-label={t('people.abdullah.linkedinLabel')}><i className='bi-linkedin'></i></a>
            <a href='https://wa.me/491636395838?text=Hallo%20Abdullah%2C%20ich%20bin%20auf%20deine%20Website%20gesto%C3%9Fen%20und%20wollte%20dich%20kontaktieren' aria-label={t('people.abdullah.whatsappLabel')}><i className='bi-whatsapp'></i></a>
          </div>
        </div>
        ...
        <div className='footer-text'>
          ...
          <Link to="/moredetails" className="more-btn">
            {t('footer.moreAboutMeBtn')}
          </Link>
        </div>
      </div>
